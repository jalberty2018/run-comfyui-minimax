...
The base H3 templates omit ControlNet downloads. Choose one of the four
Fun ControlNet Union variants below to include the patch and SDPose models.
...
HF_MODEL_LATENT_UPSCALE_FILENAME1=minimax_h3_latent_upscaler_3d_bf16.safetensors
...
HF_MODEL_LORA_FILENAME2=minimax_h3_fl2v_turbo_4step_v1.2_768p_comfyui_bf16.safetensors
...
WORKFLOW1=https://provisioning.rozenlaan.site/minimax/fl2v-pod.json
WORKFLOW2=https://provisioning.rozenlaan.site/minimax/t2v-pod.json
WORKFLOW3=https://provisioning.rozenlaan.site/minimax/director-pod.json
WORKFLOW4=https://provisioning.rozenlaan.site/minimax/turbo-fl2v-pod.json
WORKFLOW5=https://provisioning.rozenlaan.site/minimax/turbo-t2v-pod.json
WORKFLOW6=https://provisioning.rozenlaan.site/minimax/lightx2v-fl2v-pod.json
WORKFLOW7=https://provisioning.rozenlaan.site/minimax/lightx2v-t2v-pod.json
WORKFLOW8=https://provisioning.rozenlaan.site/minimax/prompt-generator-tail-pod.json
WORKFLOW9=https://provisioning.rozenlaan.site/minimax/fl2v-prompt-generator-qwenvl-pod.json
WORKFLOW10=https://provisioning.rozenlaan.site/minimax/PDD-Acc-t2v-pod.json
WORKFLOW11=https://provisioning.rozenlaan.site/minimax/PDD-Acc-fl2v-pod.json
```
...
HF_MODEL_DIR3=models/pdd_acc
WORKFLOW1=https://provisioning.rozenlaan.site/minimax/r2v-pod.json
WORKFLOW2=https://provisioning.rozenlaan.site/minimax/director-pod.json
WORKFLOW3=https://provisioning.rozenlaan.site/minimax/lightx2v-r2v-pod.json
WORKFLOW4=https://provisioning.rozenlaan.site/minimax/prompt-generator-tail-pod.json
WORKFLOW5=https://provisioning.rozenlaan.site/minimax/r2v-prompt-generator-qwenvl-pod.json
WORKFLOW6=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-pod.json
WORKFLOW7=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-prompt-builder-pod.json
WORKFLOW8=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-multi-shot-context-pin.json
WORKFLOW9=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-warmup-pod.json
WORKFLOW10=https://provisioning.rozenlaan.site/minimax/lightx2v-r2v-multi-shot.json
WORKFLOW11=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-prompt-generator-qwenvl-pod.json
WORKFLOW12=https://provisioning.rozenlaan.site/minimax/lightx2v-r2v-prompt-generator-qwenvl-pod.json
```
...
Each block includes its corresponding base template's models, hardware profiles,
prompting option and workflows, plus the Fun ControlNet Union patch and SDPose
models (about 4.34 GB extra). Requires ComfyUI 0.35.0 or later.
Select the provisioned diffusion model and text encoder in the official workflow.
For FL2VA, disable the Ref2VA Lightning LoRA option. The Ref2VA variants also
include that optional 4-step LoRA, whose download is additional to the 4.34 GB.

### MiniMax-H3 Fun ControlNet Union FL2VA with QWEN TAIL
...
HF_MODEL_VAE2=Comfy-Org/MiniMax-H3
HF_MODEL_VAE_FILENAME2=vae/minimax_h3_video_vae_fp16.safetensors
HF_MODEL_DIFFUSION_MODELS3=Comfy-Org/SDPose
HF_MODEL_DIFFUSION_MODELS_FILENAME3=diffusion_models/rt_detr_v4-x-hgnet_fp16.safetensors
HF_MODEL_PATCHES1=Comfy-Org/MiniMax-H3
HF_MODEL_PATCHES_FILENAME1=model_patches/minimax_h3_fun_controlnet_union_pruned_int8_convrot.safetensors
HF_MODEL_CHECKPOINTS1=Comfy-Org/SDPose
...
### MiniMax-H3 Fun ControlNet Union FL2VA with QWEN prompt enhancer provisioning
...
### MiniMax-H3 Fun ControlNet Union Ref2VA with TAIL
...
HF_MODEL_LORA_FILENAME2=loras/minimax_h3_ref2v_turbo_4step_v0.1_comfyui_bf16.safetensors
HF_MODEL3=aptech0081/MiniMax-H3-Acc-LoRAs-ComfyUI
HF_MODEL_FILENAME3=minimax_h3_ref2va_pdd_acc_8step_comfyui.safetensors
HF_MODEL_DIR3=models/pdd_acc
WORKFLOW1=https://provisioning.rozenlaan.site/minimax/r2v-pod.json
...
WORKFLOW11=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-prompt-generator-qwenvl-pod.json
WORKFLOW12=https://provisioning.rozenlaan.site/minimax/lightx2v-r2v-prompt-generator-qwenvl-pod.json
WORKFLOW13=https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_minimax_h3_fun_controlnet_union.json
```

### MiniMax-H3 Fun ControlNet Union Ref2VA with QWEN prompt enhancement
...
WORKFLOW1=https://provisioning.rozenlaan.site/minimax/r2v-pod.json
WORKFLOW2=https://provisioning.rozenlaan.site/minimax/director-pod.json
WORKFLOW3=https://provisioning.rozenlaan.site/minimax/prompt-generator-tail-pod.json
WORKFLOW4=https://provisioning.rozenlaan.site/minimax/r2v-prompt-generator-qwenvl-pod.json
WORKFLOW5=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-prompt-generator-qwenvl-pod.json
WORKFLOW6=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-prompt-builder-pod.json
WORKFLOW7=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-warmup-pod.json
WORKFLOW8=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-multi-shot-context-pin.json
...
WORKFLOW8=https://provisioning.rozenlaan.site/minimax/PDD-Acc-r2v-multi-shot-context-pin.json
WORKFLOW9=https://provisioning.rozenlaan.site/minimax/lightx2v-r2v-prompt-generator-qwenvl-pod.json
WORKFLOW10=https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_minimax_h3_fun_controlnet_union.json
```

### MiniMax-H3 Fun ControlNet Union FL2VA
