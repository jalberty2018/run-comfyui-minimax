...
This base template downloads FL2VA and its required models for use with manually written prompts. For optional prompt enhancement, choose the separate Qwen-VL template.
...
|---|---|---|
| [Uncensored Qwen-VL (Qwen3.8) + `llama.cpp`](https://console.runpod.io/hub/template/a1nkufhzxq?ref=se4tkc5o) | Fast local prompt generation | Larger download and more RAM |
...
1. [Deploy this FL2VA base template](https://console.runpod.io/deploy?template=v7b5g03csk&ref=se4tkc5o).
