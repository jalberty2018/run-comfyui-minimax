...
# run-comfyui-minimax
FROM ls250824/comfyui-runtime2:22082026
...
RUN --mount=type=cache,target=/root/.cache/git \
    ...
    git clone --depth=1 --filter=blob:none https://github.com/jalberty2018/comfyui-minimax-h3-prompt-enhancer-T8.git
...
# Labels
LABEL org.opencontainers.image.title="ComfyUI 0.33.0 for MiniMax H3 inference" \
